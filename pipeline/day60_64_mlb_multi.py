...
from tools.team_code_utils import norm_team_series as _norm_team
...
teams['teamID'] = _norm_team(teams['teamID'])
...
ms['teamID'] = _norm_team(ms['teamID'])
...
batg['teamID'] = _norm_team(batg['teamID'])
...
pitg['teamID'] = _norm_team(pitg['teamID'])
